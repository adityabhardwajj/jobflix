...
import { heroui } from "@heroui/react"; // HeroUI (NextUI v2) Tailwind plugin

const config: Config = {
  darkMode: ["class"], // we'll switch by swapping theme class at <html> level
  content: [
  ...
  theme: {
    extend: {
      ...
      // Optional utility mirrors for convenience (tokens still come from themes below)
